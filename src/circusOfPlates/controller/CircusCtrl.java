...
import circusOfPlates.Interfaces.State;
import circusOfPlates.model.*;
import circusOfPlates.view.Circus;
import circusOfPlates.view.GameOver;
...
public class CircusCtrl {
	...
	private int farFromCeil = 150, speed = 40, queuePace = 40, delayCount = 0, suspendPresent = 0, random1 = 0,
	...
	private void playEndSound() {
		...
		File file = new File(getClass().getResource("/circusOfPlates/supportMedia/endgame.wav").getFile());
