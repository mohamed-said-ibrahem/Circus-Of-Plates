...
import circusOfPlates.controller.InGameMenCtrl;
...
public class InGameMenu extends JPanel {
	...
	public void initMenu() {
		...
		ImageIcon icon = new ImageIcon(getClass().getResource("/circusOfPlates/supportMedia/resume.png"));
		...
		icon = new ImageIcon(getClass().getResource("/circusOfPlates/supportMedia/newgame.png"));
		...
		icon = new ImageIcon(getClass().getResource("/circusOfPlates/supportMedia/save.png"));
		...
		icon = new ImageIcon(getClass().getResource("/circusOfPlates/supportMedia/toMenu.png"));
