...
import circusOfPlates.controller.GameOverMenCtrl;
import circusOfPlates.model.ScorePair;
...
public class GameOver extends JPanel {
	...
	public void initialPanel() {
		...
		ImageIcon icon = new ImageIcon(getClass().getResource("/circusOfPlates/supportMedia/playAgain.png"));
	...
	public void paintComponent(Graphics g) {
		...
		File file = new File(getClass().getResource("/circusOfPlates/supportMedia/over.jpg").getFile());
