...
import circusOfPlates.controller.MainMenCtrl;
import circusOfPlates.model.*;
...
public class MainMenu extends JPanel {
	...
	public void initMenu() {
		...
		ImageIcon icon = new ImageIcon(getClass().getResource("/circusOfPlates/supportMedia/newgame.png"));
		...
		icon = new ImageIcon(getClass().getResource("/circusOfPlates/supportMedia/highScores.png"));
		...
		icon = new ImageIcon(getClass().getResource("/circusOfPlates/supportMedia/load.png"));
		...
		icon = new ImageIcon(getClass().getResource("/circusOfPlates/supportMedia/exit.png"));
	...
	public void playAudio(int theme) {
		if (theme == 0) {
			File file = new File(getClass().getResource("/circusOfPlates/supportMedia/circusMusic1.wav").getFile());
			String path = file.getAbsolutePath().replaceAll("%20", " ");
			AudioPlayer.main(null, path);
		} else {

			File file = new File(getClass().getResource("/circusOfPlates/supportMediacircusMusic2.wav").getFile());
			String path = file.getAbsolutePath().replaceAll("%20", " ");
			AudioPlayer.main(null, path);
		}
	}
	...
	public void paintComponent(Graphics g) {
		...
		try {
			File file = new File(getClass().getResource("/circusOfPlates/supportMedia/preview.jpg").getFile());
			String path = file.getAbsolutePath().replaceAll("%20", " ");
