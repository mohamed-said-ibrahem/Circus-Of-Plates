...
import circusOfPlates.controller.*;
import circusOfPlates.controller.MouseMotion;
import circusOfPlates.model.PlatesBar;
import circusOfPlates.model.Player;
...
public class Circus extends JPanel implements Serializable {
	...
	public Circus(boolean bypassIntro) {
		...
		theme = "/circusOfPlates/supportMedia/themes.jpg";
	...
	private void createBars() {
		...
		img = null;
		File file = new File(getClass().getResource("/circusOfPlates/supportMedia/barL.png").getFile());
		...
		file = new File(getClass().getResource("/circusOfPlates/supportMedia/barR.png").getFile());
	...
	public void createPlayers() {
		...
		img = null;
		File file = new File(getClass().getResource("/circusOfPlates/supportMedia/player1.png").getFile());
		String path = file.getAbsolutePath().replaceAll("%20", " ");
		...
		file = new File(getClass().getResource("/circusOfPlates/supportMedia/player2.png").getFile());
		path = file.getAbsolutePath().replaceAll("%20", " ");
		try {
			img = ImageIO.read((new File(path)));
		} catch (IOException e) {
	...
	private void setBackGrndImage() {
		...
		file = new File(getClass().getResource("/circusOfPlates/supportMedia/joke.png").getFile());
		path = file.getAbsolutePath().replaceAll("%20", " ");
		try {
	...
	public void resize() {
		...
		File file = new File(classLoader.getResource("circusOfPlates/supportMedia/player1.png").getFile());
		String path = file.getAbsolutePath().replaceAll("%20", " ");
		...
		file = new File(classLoader.getResource("circusOfPlates/supportMedia/player2.png").getFile());
		path = file.getAbsolutePath().replaceAll("%20", " ");
