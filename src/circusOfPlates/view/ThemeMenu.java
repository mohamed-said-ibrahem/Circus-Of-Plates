...
import circusOfPlates.controller.ThemeMenuCtrl;
...
public class ThemeMenu extends JPanel {
	...
	private void initView() {
		...
		ImageIcon icon = new ImageIcon(getClass().getResource("/circusOfPlates/supportMedia/thumbnail1.png"));
		...
		icon = new ImageIcon(getClass().getResource("/circusOfPlates/supportMedia/thumbnail2.png"));
		...
		icon = new ImageIcon(getClass().getResource("/circusOfPlates/supportMedia/thumbnail3.png"));
	...
	public void paintComponent(Graphics g) {
		...
		File file = new File(getClass().getResource("/circusOfPlates/supportMedia/themes.jpg").getFile());
