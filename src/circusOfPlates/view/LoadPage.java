...
import circusOfPlates.controller.LoadPageCtrl;
...
public class LoadPage extends JPanel {
	...
	private void initView() {
		...
		ImageIcon icon = new ImageIcon(getClass().getResource("/circusOfPlates/supportMedia/back.png"));
		...
		icon = new ImageIcon(getClass().getResource("/circusOfPlates/supportMedia/delete.png"));
		...
		innerPanel.setBorder(BorderFactory.createEmptyBorder(300, 2, labels.size() * 10 + 70, 2));
		add(innerPanel);
		...
		File file = new File(getClass().getResource("/circusOfPlates/supportMedia/loadpage.jpg").getFile());
